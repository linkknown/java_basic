...
public class ClassLoaderTest {
	...
	/**
	 * AppClassLoader的父加载器为ExtClassLoader，ExtClassLoader的父加载器为null(BoopStrap ClassLoder不在上图中，
	 * 因为它是由C/C++编写的，它本身是虚拟机的一部分，并不是一个java类。)，BoopStrap ClassLoader为顶级加载器。 
	 */
	@Test
	 ...
	 */
	@Test
	public void testCustomClassLoader () throws ClassNotFoundException, InstantiationException, IllegalAccessException {
