package com.linkknown.oop_game_saolei.panel;
...
public class FaceJPanel extends JPanel {
	...
	private void init() {
		...
		Icon icon0 = StaticTool.getImageIcon("images_saolei/d0.gif");
		Icon icon1 = StaticTool.getImageIcon("images_saolei/d" + StaticTool.allcount / 10
				+ ".gif");
		Icon icon2 =  StaticTool.getImageIcon("images_saolei/d" + StaticTool.allcount % 10
				+ ".gif");
		Icon iconSmile =  StaticTool.getImageIcon("images_saolei/face0.gif");
